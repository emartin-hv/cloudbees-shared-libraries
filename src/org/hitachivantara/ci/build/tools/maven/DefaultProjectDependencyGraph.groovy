...
/*
 * This is a copy from 3.1.0 sources
 * Consider removing this when maven-plugin upgrades it's maven-core version to at least 3.3.0
 */
    ...
    implements ProjectDependencyGraph
{
  ...
  DefaultProjectDependencyGraph( List<MavenProject> projects ) {
    this(new ProjectSorter(projects))
  }
   ...
   */
  DefaultProjectDependencyGraph( ProjectSorter sorter )
  {
    if ( sorter == null )
    {
  ...
  void getDownstreamProjects( String projectId, Collection<String> projectIds, boolean transitive )
  {
  ...
  void getUpstreamProjects( String projectId, Collection<String> projectIds, boolean transitive )
  {
